...
const adminRoutes: RouteRecordRaw[] = [
  {
    ...
    children: [
      { path: '', redirect: { name: 'admin.status' } },
      {
        ...
        meta: { requiresAdmin: true, titleKey: 'section.overview', subtitleKey: 'admin.overview.subtitle' },
      },
      {
        path: 'ops-monitor',
        name: 'admin.opsMonitor',
        component: () => import('@/views/admin/OpsMonitor.vue'),
        meta: { requiresAdmin: true, titleKey: 'admin.opsMonitor.title', subtitleKey: 'admin.opsMonitor.subtitle' },
      },
      {
        path: 'nodes',
        name: 'admin.nodes',
        component: () => import('@/views/admin/Nodes.vue'),
        meta: { requiresAdmin: true, titleKey: 'admin.nodes.title', subtitleKey: 'admin.nodes.subtitle' },
      },
      {
        path: 'inbounds',
        name: 'admin.inbounds',
        component: () => import('@/views/admin/Inbounds.vue'),
        meta: { requiresAdmin: true, titleKey: 'admin.inbounds.title', subtitleKey: 'admin.inbounds.subtitle' },
      },
      {
        path: 'users',
        name: 'admin.users',
        component: () => import('@/views/admin/Users.vue'),
        meta: { requiresAdmin: true, titleKey: 'admin.users.title', subtitleKey: 'admin.users.subtitle' },
      },
      {
        path: 'plans',
        name: 'admin.plans',
        component: () => import('@/views/admin/Plans.vue'),
        meta: { requiresAdmin: true, titleKey: 'admin.plans.title', subtitleKey: 'admin.plans.subtitle' },
      },
      {
        path: 'provisioning-pools',
        name: 'admin.provisioningPools',
        component: () => import('@/views/admin/ProvisioningPools.vue'),
        meta: { requiresAdmin: true, titleKey: 'admin.provisioningPools.title', subtitleKey: 'admin.provisioningPools.subtitle' },
      },
      {
        path: 'orders',
        name: 'admin.orders',
        component: () => import('@/views/admin/Orders.vue'),
        meta: { requiresAdmin: true, titleKey: 'admin.orders.title', subtitleKey: 'admin.orders.subtitle' },
      },
      {
        path: 'audit-log',
        name: 'admin.audit',
        component: () => import('@/views/admin/AuditLog.vue'),
        meta: { requiresAdmin: true, titleKey: 'admin.auditLog.title', subtitleKey: 'admin.auditLog.subtitle' },
      },
      {
        path: 'settings',
        name: 'admin.settings',
        component: () => import('@/views/admin/Settings.vue'),
        meta: { requiresAdmin: true, titleKey: 'admin.settings.title', subtitleKey: 'admin.settings.subtitle' },
      },
    ],
  },
]

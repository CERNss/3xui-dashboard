...
// mockPanel stands in for the 3x-ui /panel/api surface. It tracks
// addClient / updateClient / delClientByEmail so the rest of the
// dashboard sees a consistent view across calls.

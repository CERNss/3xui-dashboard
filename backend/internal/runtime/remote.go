...
// endpoint first (/addClient) and falls back to a full inbound re-
// push if the panel rejects it (different 3x-ui versions accept
...
// resolves its UUID/password, and calls /updateClient/:clientId.
// Falls back to re-push on panel error.
